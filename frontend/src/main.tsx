...
<Route path="*" element={<ProtectedApp />} /> </Routes>
);
}
...
if (loading) {
return ( <div className="splash"> <Activity size={22} />
Carregando... </div>
);
}
...
return ( <div className="login-page"> <div className="login-card"> <div className="brand-mark"> <WalletCards size={22} /> </div>
...
> <div className="brand"> <div className="brand-mark small"> <WalletCards size={18} /> </div>
...
return ( <div className="page stack gap-lg"> <div className="hero"> <div> <div className="eyebrow">SEU RESUMO</div>
...
return ( <div className="card metric"> <div className="metric-icon">
{icon} </div>
...
return ( <div className="section-head"> <div> <h3>{title}</h3> <span>Visão rápida dos registros</span> </div>
...
return ( <div className="empty"> <FileText size={28} /> <span>{text}</span> </div>
);
}
...
return ( <div className="page stack gap-lg"> <div className="hero"> <div> <div className="eyebrow">PAINEL</div>
...
return ( <div className="page stack gap-lg"> <div className="hero compact"> <div> <div className="eyebrow">
HISTÓRICO </div>
...
if (
  step === 2 &&
  (!Number(ida) || Number(ida) <= 0 || !idaFile)
) {
  setError(
...
return ( <div className="expense-step"> <div className="expense-head"> <div className="round-icon"> <WalletCards size={18} /> </div>
...
return ( <div className="summary"> <div className="summary-grid"> <SummaryItem
       label="Cliente"
       value={cliente}
     />
...
try {
  setError('');
  const data = await api(`/visitas/${id}`);
  setV(data);
} catch (err) {
  setError(
    err instanceof Error
